...
public static class UIElementDOTweenExtensions
{
    ...
    /// </summary>
    public static Sequence DOHeartbeat(this VisualElement target, float intensity = 1.15f, float duration = 0.5f)
    {
    ...
    /// </summary>
    public static Sequence DOHeartbeatContinuous(this VisualElement target, float bpm = 60f, float intensity = 1.15f)
    {
        ...
        // Second beat - smaller expansion
        sequence.Append(target.DOScale(intensity * 0.8f, beatDuration * 0.1f).SetEase(Ease.OutQuad));
    ...
    /// </summary>
    public static Sequence DORealisticHeartbeat(this VisualElement target, float bpm, float minIntensity = 1.05f, float maxIntensity = 1.3f)
    {
    ...
    public static Tweener DOColor(this VisualElement target, Color endValue, float duration)
    {
        ...
        return DOTween.To(() => startValue, x => target.style.backgroundColor = x, endValue, duration);
    }
